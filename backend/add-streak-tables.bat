@echo off
echo ========================================
echo Daily Login Streak - Database Migration
echo ========================================
echo.
...
mysql -h %DB_HOST% -u %DB_USER% -p %DB_NAME% < migrations/add_login_streaks.sql
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo.
    echo Updated views:
    echo   - user_login_summary
    echo.
    echo You can now use the daily login streak system!
) else (
    echo.
    echo ========================================
